...
def main():
    ...
    source_node_features = ['gender', 'street', 'city', 'state', 'zip', 'lat', 'long', 'city_pop',
       'job']
    ...
    edge_features = ['trans_year','trans_month', 'trans_day', 'trans_hour','category', 'amt']
    ...
    xgb_model, gnn_model, comparison = pipeline.run_full_comparison(
        ...
        final_training=True,
        dataset_name="FraudTrainDataset"  # Dataset name for plots
    )
